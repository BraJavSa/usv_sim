...
% Suponemos que tienes tus datos de velocidad y aceleración (u, v, r, dot_u, dot_v, dot_r)
% y los torques medidos (T_u, T_v, T_r), todos como vectores columna.
% Aquí, t es el vector de tiempo, y para cada k se asume que tienes los datos correspondientes.
