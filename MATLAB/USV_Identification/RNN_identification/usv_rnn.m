function [output, state] = usv_rnn(input, params, varargin)
%USV_RNN Function implementing an imported ONNX network.
%
...
%
% [OUTPUT] = usv_rnn(INPUT, PARAMS)
%			- Evaluates the imported ONNX network USV_RNN with input(s)
%			INPUT and the imported network parameters in PARAMS. Returns
%			network output(s) in OUTPUT.
%
% [OUTPUT, STATE] = usv_rnn(INPUT, PARAMS)
%			- Additionally returns state variables in STATE. When training,
%			use this form and set TRAINING to true.
%
% [__] = usv_rnn(INPUT, PARAMS, 'NAME1', VAL1, 'NAME2', VAL2, ...)
...
%				  INPUT:		[batch_size, sequence_length, 6]				Type: FLOAT
...
function [output, outputNumDims1007, state] = main_graphGraph1000(input, inputNumDims1006, Vars, NumDims, Training, state)
...
% Shape:
[Vars.x_rnn_Shape_output_0, NumDims.x_rnn_Shape_output_0] = onnxShape(Vars.input, NumDims.input);

% Gather:
[Vars.x_rnn_Gather_output_0, NumDims.x_rnn_Gather_output_0] = onnxGather(Vars.x_rnn_Shape_output_0, Vars.x_rnn_Constant_output_0, 0, NumDims.x_rnn_Shape_output_0, NumDims.x_rnn_Constant_output_0);

% Unsqueeze:
[shape, NumDims.x_rnn_Unsqueeze_output_0] = prepareUnsqueezeArgs(Vars.x_rnn_Gather_output_0, Vars.UnsqueezeAxes1001, NumDims.x_rnn_Gather_output_0);
Vars.x_rnn_Unsqueeze_output_0 = reshape(Vars.x_rnn_Gather_output_0, shape);

% Concat:
[Vars.x_rnn_Concat_output_0, NumDims.x_rnn_Concat_output_0] = onnxConcat(0, {Vars.x_rnn_Constant_1_output_0, Vars.x_rnn_Unsqueeze_output_0, Vars.x_rnn_Constant_2_output_0}, [NumDims.x_rnn_Constant_1_output_0, NumDims.x_rnn_Unsqueeze_output_0, NumDims.x_rnn_Constant_2_output_0]);

% ConstantOfShape:
[Vars.x_rnn_ConstantOfShape_output_0, NumDims.x_rnn_ConstantOfShape_output_0] = onnxConstantOfShape(Vars.ConstantOfShapeValue1002, Vars.x_rnn_Concat_output_0);

% PLACEHOLDER FUNCTION FOR UNSUPPORTED OPERATOR (RNN):
[Vars.x_rnn_RNN_output_0, Vars.x_rnn_RNN_output_1, NumDims.x_rnn_RNN_output_0, NumDims.x_rnn_RNN_output_1] = PLACEHOLDER(Vars.input, Vars.onnx__RNN_31, Vars.onnx__RNN_32, Vars.onnx__RNN_33, Vars.x_rnn_ConstantOfShape_output_0);

% Squeeze:
[Vars.x_rnn_Squeeze_output_0, NumDims.x_rnn_Squeeze_output_0] = onnxSqueeze(Vars.x_rnn_RNN_output_0, Vars.SqueezeAxes1003, NumDims.x_rnn_RNN_output_0);

% Gather:
[Vars.x_Gather_output_0, NumDims.x_Gather_output_0] = onnxGather(Vars.x_rnn_Squeeze_output_0, Vars.x_Constant_output_0, 1, NumDims.x_rnn_Squeeze_output_0, NumDims.x_Constant_output_0);

% Gemm:
[A, B, C, alpha, beta, NumDims.output] = prepareGemmArgs(Vars.x_Gather_output_0, Vars.fc_weight, Vars.fc_bias, Vars.Gemmalpha1004, Vars.Gemmbeta1005, 0, 1, NumDims.fc_bias);
Vars.output = alpha*B*A + beta*C;

% Set graph output arguments from Vars and NumDims:
output = Vars.output;
outputNumDims1007 = NumDims.output;
% Set output state from Vars:
state = updateStruct(state, Vars);
end

function [inputDataPerms, outputDataPerms, Training] = parseInputs(input, numDataOutputs, params, varargin)
% Function to validate inputs to usv_rnn:
p = inputParser;
...
% Check input size(s):
checkInputSize(size(input), {'batch_size' 'sequence_length' 6}, "input");
end
