...
for k = 1:length(t)
    ...
    Yn = [
        acc_u,   0, 0, -vel_v*yaw_rate,   -vel_v*yaw_rate,   0,      vel_u,      0,      0;
        0,    acc_v,  0, vel_u*yaw_rate,  0,     vel_u*yaw_rate,      0,     vel_v,      0;
        0,0,  acc_r , 0,   vel_v*vel_u,  -vel_v*vel_u,      0,      0,      yaw_rate
    ];
